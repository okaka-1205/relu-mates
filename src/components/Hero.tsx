    ...
    <section id="top" className="scroll-scene is-visible relative flex min-h-[780px] overflow-hidden bg-[#f6f8fc] pt-20 text-[#001d50] sm:min-h-[min(900px,100svh)]">
      ...
      <div className="relative mx-auto flex w-full max-w-[1440px] flex-col justify-between px-5 pb-7 pt-12 sm:px-8 sm:pb-10 lg:px-12 lg:pt-20">
        ...
        <div className="my-auto py-16 lg:py-20">
          <div className="mb-8 flex items-center gap-4"><img className="h-20 w-20 rounded-full bg-white object-contain p-1 shadow-sm sm:h-24 sm:w-24" src="/relu-mates-logo.png" alt="ReLU Mates ロゴ" /><p className="text-sm font-bold leading-6 text-[#23477b]">つながる。学ぶ。挑戦する。</p></div>
          <p className="mb-6 max-w-2xl text-sm leading-7 text-[#23477b] sm:text-base">ReLU Matesは、会津大学の学生が運営するコミュニティです。学生、地域、企業が出会い、会津・福島で新しい挑戦を生み出します。</p>
