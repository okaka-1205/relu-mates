...
export function Hero() {
  return (
    <section id="top" className="scroll-scene is-visible relative flex min-h-[700px] overflow-hidden bg-[#f6f8fc] pt-16 text-[#001d50] sm:min-h-[min(900px,100svh)] sm:pt-20">
      ...
      <div className="relative mx-auto flex w-full max-w-[1440px] flex-col justify-between px-5 pb-6 pt-8 sm:px-8 sm:pb-10 sm:pt-12 lg:px-12 lg:pt-20">
        ...
        <div className="flex items-end justify-between border-t border-[#001d50]/15 pt-5 text-xs font-medium text-[#23477b]"><p>会津若松市／福島県</p><p className="hidden text-right sm:block">下へスクロール<br />↓</p></div>
      </div>
    </section>
  )
}
